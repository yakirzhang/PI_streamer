...
class FeatureState {
 public:
   ...
   */
  virtual bool Get2dFeatures(std::vector<PIRVS::Point2d> *features_l,
                             std::vector<PIRVS::Point2d> *features_r) const = 0;
...
class Map {
 public:
   ...
   */
  virtual bool GetPoints(std::vector<PIRVS::Point3d> *points) const = 0;
};
...
class SlamState {
 public:
   ...
   */
  virtual bool GetPose(PIRVS::Affine3d *pose) const = 0;
   ...
   * @return True if pose is available. False otherwise.
   */
  virtual bool GetPoseInQuaternion(PoseInQuaternion *pose_ptr) const = 0;
};
...
class TrajectoryDrawer {
 public:
   ...
   *         \p img is NULL.
   */
  bool Draw(std::shared_ptr<const SlamState> state, PIRVS::Mat *img);
